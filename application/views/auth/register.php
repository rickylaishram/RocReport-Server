<div class="container-fluid">
	<form class="form-signin" role="form">
		...
		<div id="message"></div>
		<input type="text" class="form-control" placeholder="Username" required autofocus id="name">
		<input type="email" class="form-control" placeholder="Email address" required autofocus id="email">
		<input type="password" class="form-control" placeholder="Password" required id="pass1">
		<input type="password" class="form-control" placeholder="Confirm Password" required id="pass2">
